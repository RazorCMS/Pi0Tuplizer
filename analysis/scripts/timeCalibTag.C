...
void timeCalibTag(std::string input_list="list_EcalTimeCalibConstants_Legacy2016_v1.list", std::string outfileName = "/eos/cms/store/group/phys_susy/razor/EcalTiming/EcalTimeCalibConstants_Legacy2016_v1/EcalTimeCalibConstants_Legacy2016_v1.root")
{
