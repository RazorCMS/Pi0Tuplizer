...
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string("etaNtuple.root"),
...
pi0PtCut_barrel1 = cms.untracked.double(4.0),
pi0PtCut_barrel2 = cms.untracked.double(4.0),
pi0PtCut_endcap1 = cms.untracked.double(3.0),
pi0PtCut_endcap2 = cms.untracked.double(3.0),
gPtCut_barrel1 = cms.untracked.double(1.2),
gPtCut_barrel2 = cms.untracked.double(1.2),
gPtCut_endcap1 = cms.untracked.double(1.0),
gPtCut_endcap2 = cms.untracked.double(0.7),
s4s9Cut_barrel1 = cms.untracked.double(0.87),
s4s9Cut_barrel2 = cms.untracked.double(0.87),
s4s9Cut_endcap1 = cms.untracked.double(0.90),
s4s9Cut_endcap2 = cms.untracked.double(0.90),
