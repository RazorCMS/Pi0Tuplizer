...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("pi0Ntuple_offline.root"),
...
gPtCut_barrel1_Eta_ = cms.untracked.double(1.30),
...
s4s9Cut_endcap1_Eta_ = cms.untracked.double(0.95),
s4s9Cut_endcap2_Eta_ = cms.untracked.double(0.95),
